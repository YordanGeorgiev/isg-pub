# src/bash/isg-pub/funcs/remove-package-files.help.sh
...
doHelpRemovePackageFiles(){
	...
	cat doc/txt/isg-pub/helps/remove-package-files.help.txt
...
# eof file: src/bash/isg-pub/funcs/remove-package-files.help.sh
