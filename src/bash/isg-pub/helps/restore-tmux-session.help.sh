# src/bash/isg-pub/funcs/restore-tmux-session.help.sh
...
doHelpRestoreTmuxSession(){
	...
	cat doc/txt/isg-pub/helps/restore-tmux-session.help.txt
...
# eof file: src/bash/isg-pub/funcs/restore-tmux-session.help.sh
