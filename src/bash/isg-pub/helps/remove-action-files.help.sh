# src/bash/isg-pub/funcs/remove-action-files.help.sh
...
doHelpRemoveActionFiles(){
	...
	cat doc/txt/isg-pub/helps/remove-action-files.help.txt
...
# eof file: src/bash/isg-pub/funcs/remove-action-files.help.sh
