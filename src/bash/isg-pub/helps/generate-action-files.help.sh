# src/bash/isg-pub/funcs/generate-action-files.help.sh
...
doHelpGenerateActionFiles(){
	...
	cat doc/txt/isg-pub/helps/generate-action-files.help.txt
...
# eof file: src/bash/isg-pub/funcs/generate-action-files.help.sh
