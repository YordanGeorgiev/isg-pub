# src/bash/isg-pub/funcs/action-to-remove.help.sh
...
doHelpActionToRemove(){
	...
	cat doc/txt/isg-pub/helps/action-to-remove.help.txt
...
# eof file: src/bash/isg-pub/funcs/action-to-remove.help.sh
