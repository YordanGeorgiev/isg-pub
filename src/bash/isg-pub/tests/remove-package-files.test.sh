# src/bash/isg-pub/funcs/remove-package-files.test.sh
...
doTestRemovePackageFiles(){
	...
	cat doc/txt/isg-pub/tests/remove-package-files.test.txt
...
# eof file: src/bash/isg-pub/funcs/remove-package-files.test.sh
