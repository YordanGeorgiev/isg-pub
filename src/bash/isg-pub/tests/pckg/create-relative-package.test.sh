...
doTestCreateRelativePackage(){
   ...
   bash src/bash/isg-pub/isg-pub.sh -a create-relative-package -i met/.tst.isg-pub
   export exit_code=$?
   ...
   test $exit_code -ne 0 && return
	...
	bash src/bash/isg-pub/isg-pub.sh -a create-relative-package -i met/.prd.isg-pub
   export exit_code=$?
   ...
   # test the call with the include file of the prd env
   bash src/bash/isg-pub/isg-pub.sh -a create-relative-package -i met/.git.isg-pub
   export exit_code=$?
