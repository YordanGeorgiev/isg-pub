# src/bash/isg-pub/funcs/create-full-7z-package.test.sh
...
doTestCreateFull7zPackage(){
	...
	cat doc/txt/isg-pub/tests/pckg/create-full-7z-package.test.txt
	
	doSpecCreateFull7zPackage
	doHelpCreateFull7zPackage

	# add your action implementation code here ... 
	bash src/bash/isg-pub/isg-pub.sh -a create-full-7z-package
...
# eof file: src/bash/isg-pub/funcs/create-full-7z-package.test.sh
