# src/bash/isg-pub/funcs/action-to-remove.test.sh
...
doTestActionToRemove(){
	...
	cat doc/txt/isg-pub/tests/action-to-remove.test.txt
...
# eof file: src/bash/isg-pub/funcs/action-to-remove.test.sh
