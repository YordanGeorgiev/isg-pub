# src/bash/isg-pub/funcs/action-to-remove.spec.sh
...
doSpecActionToRemove(){
	...
	cat doc/txt/isg-pub/specs/action-to-remove.spec.txt
...
# eof file: src/bash/isg-pub/funcs/action-to-remove.spec.sh
