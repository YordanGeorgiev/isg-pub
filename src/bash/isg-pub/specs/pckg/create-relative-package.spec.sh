# src/bash/isg-pub/funcs/create-relative-package.spec.sh
...
doSpecCreateRelativePackage(){
	...
	cat doc/txt/isg-pub/specs/pckg/create-relative-package.spec.txt
...
# eof file: src/bash/isg-pub/funcs/create-relative-package.spec.sh
