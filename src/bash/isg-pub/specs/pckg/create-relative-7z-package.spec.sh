# src/bash/isg-pub/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/isg-pub/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/isg-pub/funcs/create-relative-7z-package.spec.sh
