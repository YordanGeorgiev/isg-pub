# src/bash/isg-pub/funcs/remove-package-files.spec.sh
...
doSpecRemovePackageFiles(){
	...
	cat doc/txt/isg-pub/specs/remove-package-files.spec.txt
...
# eof file: src/bash/isg-pub/funcs/remove-package-files.spec.sh
