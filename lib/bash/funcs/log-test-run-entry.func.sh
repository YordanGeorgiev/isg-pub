# src/bash/isg-pub/funcs/log-test-run-entry.func.sh
...
doLogTestRunEntry(){
   ...
   case "$1" in
     INIT)
         # cat doc/txt/isg-pub/funcs/log-test-run-entry.func.txt
...
# eof file: src/bash/isg-pub/funcs/log-test-run-entry.func.sh
