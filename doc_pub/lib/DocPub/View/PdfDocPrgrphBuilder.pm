package DocPub::View::PdfDocPrgrphBuilder ; 
   ...
   # -----------------------------------------------------------------------------
	sub doBuildControl {
		...
		#debug print "PdfDocPrgrphBuilder row_image_data " . p($row_image_data) . "\n" ; 
		...
		#debug print 'doc_pub/lib/DocPub/View/PdfDocPrgrphBuilder.pm' . "\n" ; 
