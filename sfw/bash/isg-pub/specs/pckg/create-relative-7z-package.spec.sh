# sfw/bash/isg-pub/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat docs/txt/isg-pub/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: sfw/bash/isg-pub/funcs/create-relative-7z-package.spec.sh
