...
doPrintHelp(){
   ...
   #------------------------------------------------------------------------------
      ...
      #--------------------------------------------------------
		...
		You must specify the files to be be included in the full package from the meta/isg-pub.dev 
		file
      ...
      #------------------------------------------------------------------------------
		...
		where <<full_package>> should look like: isg-pub.0.0.2.prd.20160702_181412.ysg-host-name.zip
