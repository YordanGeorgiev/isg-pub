...
--+-----------+--------------+------+-----+---------+-------+
SELECT '== START == adding item 1.2.1' AS '' ; 
--
-- lock the table 
...
SELECT @pLeftRank := LeftRank from Item where ItemId=4 ; 
--
...
-- OBS !!! check the id 
INSERT into Item VALUES ( 5 , 3 , NULL , 1 , @pLeftRank+1 , @pLeftRank+2,'1.2.1' ) ;
--
-- tell the user 
SELECT '== STOP == adding item 1.2.1' AS '' ;
--
-- verify the result 
